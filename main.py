...
def uus_raam():
    ...
    graafik_1 = Button(uusraam, text="Aastad",command = graafik3, font=("Graphique", 15),bg="white", fg="red2").pack(pady=25)
    graafik_2 = Button(uusraam, text="Aastajad", command = graafik2, font=("Graphique", 15),bg="white", fg="red2").pack(pady=25)
    graafik_3 = Button(uusraam, text="Nädalapäevad", command = graafik1, font=("Graphique", 15),bg="white", fg="red2").pack(pady=25)
    graafik_4 = Button(uusraam, text="Kellaajad", command=graafik4, font=("Graphique", 15),bg="white", fg="red2").pack(pady=25)
...
def graafik1():
    with open("KertuViewingActivity.csv", encoding = "utf-8") as f:
        loeb = csv.reader(f)
...
def graafik2():
    ...
    plot.title("Oled vaadanud seda nende aastaaegadel")
    plot.show()
...
def graafik3():
    with open("KertuViewingActivity.csv", encoding = "utf-8") as f:
        ...
        plot.title("Oled vaadanud seda nendel aastatel")
        plot.show()
...
sisend = Entry(raam, width=40, font="Graphique 15", fg = "red2")
sisend.pack()
